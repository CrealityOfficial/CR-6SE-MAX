...
=======
  #define MOTHERBOARD BOARD_CREALITY_F401VE
>>>>>>> mcu_ctrl
#endif
...
=======
#define EXTRUDE_MAXLENGTH 1100//200
>>>>>>> mcu_ctrl
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -15, 0 }

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 10//5
...
#define Z_PROBE_LOW_POINT          -10//-2 // Farthest distance below the trigger-point to go before stopping
...
=======
  // #define ENABLE_LEVELING_FADE_HEIGHT
    ...
    #define DEFAULT_LEVELING_FADE_HEIGHT 2.0//10.0 // (mm) Default fade height.
  #endif
>>>>>>> mcu_ctrl
...
#define DWIN_CREALITY_SERMOON_V2
//
//#define TOUCH_SCREEN
...
// 开启BLtouch + 下限位功能
#if ENABLED(DWIN_CREALITY_SERMOON_V2) && ENABLED(BLTOUCH) && Z_HOME_DIR > 0
